...
CompteBancaire::CompteBancaire(const QString& id, const QString& numeroCompte,
                               const QString& nomTitulaire, double soldeInitial,
                               const QString& banque)
    : m_id(id), m_numeroCompte(numeroCompte), m_nomTitulaire(nomTitulaire),
    m_solde(soldeInitial), m_banque(banque) {}
